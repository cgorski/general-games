...
main =
  do
    ...
    randHighCards <-
      ...
      in evalRandIO $ replicateM 10000 r
    ...
    hspec $ do
      ...
      describe "Game.Game.Poker.randomHighCard" $ do
        ...
        it "returns 10000 random HighCards" $ do 
      ...
      describe "Game.Game.Poker.randomPair" $ do
        ...
        it "returns 10000 random Pairs" $ do 
      ...
      describe "Game.Game.Poker.randomTwoPair" $ do
        ...
        it "returns 10000 random TwoPairs" $ do 
      ...
      describe "Game.Game.Poker.randomThreeOfAKind" $ do
        ...
        it "returns 10000 random ThreeOfAKinds" $ do 
      ...
      describe "Game.Game.Poker.randomStraight" $ do
        ...
        it "returns 10000 random Straights" $ do 
      ...
      describe "Game.Game.Poker.randomFlush" $ do
        ...
        it "returns 10000 random Flushes" $ do 
      ...
      describe "Game.Game.Poker.randomFullHouse" $ do
        ...
        it "returns 10000 random Full Houses" $ do 
      ...
      describe "Game.Game.Poker.randomFourOfAKind" $ do
        ...
        it "returns 10000 random Four-of-a-Kinds" $ do 
      ...
      describe "Game.Game.Poker.randomStraightFlush" $ do
        ...
        it "returns 10000 random Straight Flushes" $ do 
      ...
      describe "Game.Game.Poker.randomRoyalFlush" $ do
        ...
        it "returns 10000 random Royal Flushes" $ do 
